  ...
  "The frontend-server" should {
      ...
      new WithServer(app = application, port = 9000) {
        WsTestClient.withClient { implicit client =>
          val response: WSResponse = Await.result[WSResponse](client.
            url("***REMOVED***://localhost:9001/ckan/datasets").
            get, Duration.Inf)
    ...
    "Call ckan/createOrganization respond success" in
      new WithServer(app = application, port = 9000) {
        val json =
          WsTestClient.withClient { implicit client =>
            val response: WSResponse = Await.result[WSResponse](client.
              url("***REMOVED***://localhost:9001/ckan/createOrganization").post(readJsonFile("test/org.json")), Duration.Inf)
    ...
    "Call ckan/createDataset respond success" in
      new WithServer(app = application, port = 9000) {
        ...
        WsTestClient.withClient { implicit client =>
          val response: WSResponse = Await.result[WSResponse](client.
            url("***REMOVED***://localhost:9001/ckan/createDataset").post(readJsonFile("test/data.json")), Duration.Inf)
          //println(response.body)
          response.body must contain(""""success":true""")
        }
      }
    ...
    "Call ckan/dataset respond success" in
      new WithServer(app = application, port = 9000) {
        val json =
          WsTestClient.withClient { implicit client =>
            val response: WSResponse = Await.result[WSResponse](client.
              url("***REMOVED***://localhost:9001/ckan/dataset/test-dcatapit-api-prova").get, Duration.Inf)
            //println(response.body)
            response.body must contain(""""success":true""")
          }
      }
    ...
    "Call ckan/deleteDataset respond success" in
      new WithServer(app = application, port = 9000) {
        WsTestClient.withClient { implicit client =>
          val response: WSResponse = Await.result[WSResponse](client.
            url("***REMOVED***://localhost:9001/ckan/deleteDataset/test-dcatapit-api-prova").delete, Duration.Inf)
          //println(response.body)
          response.body must contain(""""success":true""")
        }
      }
    ...
    "Call ckan/purge Dataset respond success" in
      new WithServer(app = application, port = 9000) {
        WsTestClient.withClient { implicit client =>
          val response: WSResponse = Await.result[WSResponse](client.
            url("***REMOVED***://localhost:9001/ckan/purgeDataset/test-dcatapit-api-prova").delete, Duration.Inf)
          //println(response.body)
          response.body must contain(""""success":true""")
        }
      }
    ...
    "Call ckan/deleteOrganization respond success" in
      new WithServer(app = application, port = 9000) {
        WsTestClient.withClient { implicit client =>
          val response: WSResponse = Await.result[WSResponse](client.
            url("***REMOVED***://localhost:9001/ckan/deleteOrganization/test-org").delete, Duration.Inf)
          //println(response.body)
          response.body must contain(""""success":true""")
        }
      }
    ...
    "Call ckan/purgeOrganization respond success" in
      new WithServer(app = application, port = 9000) {
        WsTestClient.withClient { implicit client =>
          val response: WSResponse = Await.result[WSResponse](client.
            url("***REMOVED***://localhost:9001/ckan/purgeOrganization/test-org").delete, Duration.Inf)
          //println(response.body)
          response.body must contain(""""success":true""")
        }
      }
