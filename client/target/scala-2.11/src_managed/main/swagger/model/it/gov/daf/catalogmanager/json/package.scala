...
package object json {
  ...
  implicit lazy val MetadataReads: Reads[Metadata] = Reads[Metadata] {
    json => JsSuccess(Metadata((json \ "title").asOpt[String], (json \ "desc").asOpt[String], (json \ "field_type").asOpt[String], (json \ "required").asOpt[Int], (json \ "uniq_dim").asOpt[Boolean], (json \ "is_createdate").asOpt[Boolean], (json \ "is_updatedate").asOpt[Boolean], (json \ "cat").asOpt[String], (json \ "tag").asOpt[List[String]], (json \ "semantics").asOpt[Semantic], (json \ "constr").asOpt[List[Constr]], (json \ "personal").asOpt[Personal], (json \ "format_std").asOpt[FormatStd], (json \ "field_profile").asOpt[FieldProfile]))
  }
  implicit lazy val MetadataWrites: Writes[Metadata] = Writes[Metadata] {
    o => JsObject(Seq("title" -> Json.toJson(o.title), "desc" -> Json.toJson(o.desc), "field_type" -> Json.toJson(o.field_type), "required" -> Json.toJson(o.required), "uniq_dim" -> Json.toJson(o.uniq_dim), "is_createdate" -> Json.toJson(o.is_createdate), "is_updatedate" -> Json.toJson(o.is_updatedate), "cat" -> Json.toJson(o.cat), "tag" -> Json.toJson(o.tag), "semantics" -> Json.toJson(o.semantics), "constr" -> Json.toJson(o.constr), "personal" -> Json.toJson(o.personal), "format_std" -> Json.toJson(o.format_std), "field_profile" -> Json.toJson(o.field_profile)).filter(_._2 != JsNull))
  }
  ...
  implicit lazy val SemanticReads: Reads[Semantic] = Reads[Semantic] {
    json => JsSuccess(Semantic((json \ "id").as[String], (json \ "id_label").asOpt[String], (json \ "context").asOpt[String], (json \ "context_label").asOpt[String], (json \ "subject").asOpt[String], (json \ "predicate").asOpt[String], (json \ "rdf_object").asOpt[String], (json \ "uri_voc").asOpt[String], (json \ "uri_property").asOpt[String], (json \ "property_hierarchy").asOpt[List[String]]))
  }
  implicit lazy val SemanticWrites: Writes[Semantic] = Writes[Semantic] {
    o => JsObject(Seq("id" -> Json.toJson(o.id), "id_label" -> Json.toJson(o.id_label), "context" -> Json.toJson(o.context), "context_label" -> Json.toJson(o.context_label), "subject" -> Json.toJson(o.subject), "predicate" -> Json.toJson(o.predicate), "rdf_object" -> Json.toJson(o.rdf_object), "uri_voc" -> Json.toJson(o.uri_voc), "uri_property" -> Json.toJson(o.uri_property), "property_hierarchy" -> Json.toJson(o.property_hierarchy)).filter(_._2 != JsNull))
  }
  ...
  implicit lazy val PersonalReads: Reads[Personal] = Reads[Personal] {
    json => JsSuccess(Personal((json \ "ispersonal").as[Boolean], (json \ "cat").asOpt[String]))
  }
  implicit lazy val PersonalWrites: Writes[Personal] = Writes[Personal] {
    o => JsObject(Seq("ispersonal" -> Json.toJson(o.ispersonal), "cat" -> Json.toJson(o.cat)).filter(_._2 != JsNull))
  }
  implicit lazy val FormatStdReads: Reads[FormatStd] = Reads[FormatStd] {
    json => JsSuccess(FormatStd((json \ "name").as[String], (json \ "param").asOpt[String]))
  }
  implicit lazy val FormatStdWrites: Writes[FormatStd] = Writes[FormatStd] {
    o => JsObject(Seq("name" -> Json.toJson(o.name), "param" -> Json.toJson(o.param)).filter(_._2 != JsNull))
  }
  implicit lazy val FieldProfileReads: Reads[FieldProfile] = Reads[FieldProfile] {
    json => JsSuccess(FieldProfile((json \ "is_index").asOpt[Boolean], (json \ "is_profile").asOpt[Boolean], (json \ "validation").asOpt[List[String]], (json \ "standardization").asOpt[List[String]]))
  }
  implicit lazy val FieldProfileWrites: Writes[FieldProfile] = Writes[FieldProfile] {
    o => JsObject(Seq("is_index" -> Json.toJson(o.is_index), "is_profile" -> Json.toJson(o.is_profile), "validation" -> Json.toJson(o.validation), "standardization" -> Json.toJson(o.standardization)).filter(_._2 != JsNull))
  }
  implicit lazy val OperationalReads: Reads[Operational] = Reads[Operational] {
    json => JsSuccess(Operational((json \ "theme").as[String], (json \ "subtheme").as[String], (json \ "logical_uri").as[String], (json \ "physical_uri").asOpt[String], (json \ "is_std").as[Boolean], (json \ "group_own").as[String], (json \ "group_access").asOpt[List[GroupAccess]], (json \ "std_schema").asOpt[StdSchema], (json \ "read_type").as[String], (json \ "georef").asOpt[List[GeoRef]], (json \ "input_src").as[InputSrc], (json \ "ingestion_pipeline").asOpt[List[String]], (json \ "storage_info").asOpt[StorageInfo], (json \ "dataset_type").as[String], (json \ "file_type").asOpt[String], (json \ "partitions").asOpt[Partitions], (json \ "dataset_proc").asOpt[DatasetProc], (json \ "ext_opendata").asOpt[ExtOpenData], (json \ "acl").asOpt[List[Acl]]))
  }
  implicit lazy val OperationalWrites: Writes[Operational] = Writes[Operational] {
    o => JsObject(Seq("theme" -> Json.toJson(o.theme), "subtheme" -> Json.toJson(o.subtheme), "logical_uri" -> Json.toJson(o.logical_uri), "physical_uri" -> Json.toJson(o.physical_uri), "is_std" -> Json.toJson(o.is_std), "group_own" -> Json.toJson(o.group_own), "group_access" -> Json.toJson(o.group_access), "std_schema" -> Json.toJson(o.std_schema), "read_type" -> Json.toJson(o.read_type), "georef" -> Json.toJson(o.georef), "input_src" -> Json.toJson(o.input_src), "ingestion_pipeline" -> Json.toJson(o.ingestion_pipeline), "storage_info" -> Json.toJson(o.storage_info), "dataset_type" -> Json.toJson(o.dataset_type), "file_type" -> Json.toJson(o.file_type), "partitions" -> Json.toJson(o.partitions), "dataset_proc" -> Json.toJson(o.dataset_proc), "ext_opendata" -> Json.toJson(o.ext_opendata), "acl" -> Json.toJson(o.acl)).filter(_._2 != JsNull))
  }
  implicit lazy val ExtOpenDataReads: Reads[ExtOpenData] = Reads[ExtOpenData] {
    json => JsSuccess(ExtOpenData((json \ "id").as[String], (json \ "name").as[String], (json \ "url").as[String], (json \ "resourceId").as[String], (json \ "resourceName").as[String], (json \ "resourceUrl").as[String]))
  }
  implicit lazy val ExtOpenDataWrites: Writes[ExtOpenData] = Writes[ExtOpenData] {
    o => JsObject(Seq("id" -> Json.toJson(o.id), "name" -> Json.toJson(o.name), "url" -> Json.toJson(o.url), "resourceId" -> Json.toJson(o.resourceId), "resourceName" -> Json.toJson(o.resourceName), "resourceUrl" -> Json.toJson(o.resourceUrl)).filter(_._2 != JsNull))
  }
  ...
  implicit lazy val AclWrites: Writes[Acl] = Writes[Acl] {
    o => JsObject(Seq("groupName" -> Json.toJson(o.groupName), "groupType" -> Json.toJson(o.groupType), "permission" -> Json.toJson(o.permission)).filter(_._2 != JsNull))
  }
  ...
  implicit lazy val PartitionsWrites: Writes[Partitions] = Writes[Partitions] {
    o => JsObject(Seq("name" -> Json.toJson(o.name), "field" -> Json.toJson(o.field), "formula" -> Json.toJson(o.formula)).filter(_._2 != JsNull))
  }
  implicit lazy val DatasetProcReads: Reads[DatasetProc] = Reads[DatasetProc] {
    json => JsSuccess(DatasetProc((json \ "dataset_type").as[String], (json \ "read_type").as[String], (json \ "partitions").asOpt[Partitions], (json \ "merge_strategy").as[String], (json \ "cron").as[String]))
  }
  implicit lazy val DatasetProcWrites: Writes[DatasetProc] = Writes[DatasetProc] {
    o => JsObject(Seq("dataset_type" -> Json.toJson(o.dataset_type), "read_type" -> Json.toJson(o.read_type), "partitions" -> Json.toJson(o.partitions), "merge_strategy" -> Json.toJson(o.merge_strategy), "cron" -> Json.toJson(o.cron)).filter(_._2 != JsNull))
  }
  ...
  implicit lazy val DatasetReads: Reads[Dataset] = Reads[Dataset] {
    json => JsSuccess(Dataset((json \ "alternate_identifier").asOpt[String], (json \ "author").asOpt[String], (json \ "frequency").asOpt[String], (json \ "groups").asOpt[List[Group]], (json \ "holder_identifier").asOpt[String], (json \ "holder_name").asOpt[String], (json \ "identifier").asOpt[String], (json \ "license_id").asOpt[String], (json \ "modified").asOpt[String], (json \ "name").as[String], (json \ "notes").as[String], (json \ "organization").asOpt[Organization], (json \ "owner_org").asOpt[String], (json \ "privatex").asOpt[Boolean], (json \ "publisher_identifier").asOpt[String], (json \ "publisher_name").asOpt[String], (json \ "relationships_as_object").asOpt[List[Relationship]], (json \ "relationships_as_subject").asOpt[List[Relationship]], (json \ "resources").asOpt[List[Resource]], (json \ "tags").asOpt[List[Tag]], (json \ "theme").asOpt[String], (json \ "title").asOpt[String]))
  }
  implicit lazy val DatasetWrites: Writes[Dataset] = Writes[Dataset] {
    o => JsObject(Seq("alternate_identifier" -> Json.toJson(o.alternate_identifier), "author" -> Json.toJson(o.author), "frequency" -> Json.toJson(o.frequency), "groups" -> Json.toJson(o.groups), "holder_identifier" -> Json.toJson(o.holder_identifier), "holder_name" -> Json.toJson(o.holder_name), "identifier" -> Json.toJson(o.identifier), "license_id" -> Json.toJson(o.license_id), "modified" -> Json.toJson(o.modified), "name" -> Json.toJson(o.name), "notes" -> Json.toJson(o.notes), "organization" -> Json.toJson(o.organization), "owner_org" -> Json.toJson(o.owner_org), "privatex" -> Json.toJson(o.privatex), "publisher_identifier" -> Json.toJson(o.publisher_identifier), "publisher_name" -> Json.toJson(o.publisher_name), "relationships_as_object" -> Json.toJson(o.relationships_as_object), "relationships_as_subject" -> Json.toJson(o.relationships_as_subject), "resources" -> Json.toJson(o.resources), "tags" -> Json.toJson(o.tags), "theme" -> Json.toJson(o.theme), "title" -> Json.toJson(o.title)).filter(_._2 != JsNull))
  }
