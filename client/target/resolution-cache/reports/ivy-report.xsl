...
<xsl:stylesheet version="1.0"
  xmlns:xsl="***REMOVED***://www.w3.org/1999/XSL/Transform">
...
<xsl:template name="icons">
    ...
    <xsl:if test="$revision/@searched = 'true'">
         <img src="***REMOVED***://ant.apache.org/ivy/images/searched.gif" alt="searched" title="required a search in repository"/>
    </xsl:if>
    <xsl:if test="$revision/@downloaded = 'true'">
         <img src="***REMOVED***://ant.apache.org/ivy/images/downloaded.gif" alt="downloaded" title="downloaded from repository"/>
    </xsl:if>
    <xsl:if test="$revision/@evicted">
        <xsl:element name="img">
            <xsl:attribute name="src">***REMOVED***://ant.apache.org/ivy/images/evicted.gif</xsl:attribute>
    ...
    <xsl:if test="$revision/@error">
        <xsl:element name="img">
            <xsl:attribute name="src">***REMOVED***://ant.apache.org/ivy/images/error.gif</xsl:attribute>
...
<xsl:template match="/ivy-report">
  ...
  <head>
    ...
    <meta ***REMOVED***-equiv="content-type" content="text/html; charset=ISO-8859-1" />
    <meta ***REMOVED***-equiv="content-language" content="en" />
    <meta name="robots" content="index,follow" />
    <link rel="stylesheet" type="text/css" href="ivy-report.css" /> 
  </head>
  <body>
    <div id="logo"><a href="***REMOVED***://ant.apache.org/ivy/"><img src="***REMOVED***://ant.apache.org/ivy/images/logo.png"/></a></div>
    <h1>
      <xsl:element name="a">
    ...
    <h2>Dependencies Stats</h2>
        <table class="header">
          ...
          <tr><td class="title">Revisions</td><td class="value"><xsl:value-of select="count($revisions)"/>  
            (<xsl:value-of select="count($searcheds)"/> searched <img src="***REMOVED***://ant.apache.org/ivy/images/searched.gif" alt="searched" title="module revisions which required a search with a dependency resolver to be resolved"/>,
            <xsl:value-of select="count($downloadeds)"/> downloaded <img src="***REMOVED***://ant.apache.org/ivy/images/downloaded.gif" alt="downloaded" title="module revisions for which ivy file was downloaded by dependency resolver"/>,
            <xsl:value-of select="count($evicteds)"/> evicted <img src="***REMOVED***://ant.apache.org/ivy/images/evicted.gif" alt="evicted" title="module revisions which were evicted by others"/>,
            <xsl:value-of select="count($errors)"/> errors <img src="***REMOVED***://ant.apache.org/ivy/images/error.gif" alt="error" title="module revisions on which error occurred"/>)</td></tr>
