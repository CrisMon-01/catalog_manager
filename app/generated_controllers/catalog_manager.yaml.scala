...
import it.gov.***REMOVED***.catalogmanager.listeners.IngestionListenerImpl
import it.gov.***REMOVED***.catalogmanager.service.{CkanRegistry,ServiceRegistry}
...
import it.gov.***REMOVED***.catalogmanager.service.VocServiceRegistry
...
import it.gov.***REMOVED***.catalogmanager.kylo.KyloTrasformers
import catalog_manager.yaml
import it.gov.***REMOVED***.catalogmanager.kylo.Kylo
...
package catalog_manager.yaml {
    ...
    class Catalog_managerYaml @Inject() (
        ...
        val voc_dcat2***REMOVED***subtheme = voc_dcat2***REMOVED***subthemeAction { input: (String, String) =>
            val (themeid, subthemeid) = input
            // ----- Start of unmanaged code area for action  Catalog_managerYaml.voc_dcat2***REMOVED***subtheme
            val themeList: Seq[VocKeyValueSubtheme] = VocServiceRegistry.vocRepository.dcat2DafSubtheme(input._1, input._2)
            Voc_dcat2***REMOVED***subtheme200(themeList)
            // ----- End of unmanaged code area for action  Catalog_managerYaml.voc_dcat2***REMOVED***subtheme
        }
        ...
        val voc_***REMOVED***2dcatsubtheme = voc_***REMOVED***2dcatsubthemeAction { input: (String, String) =>
            val (themeid, subthemeid) = input
            // ----- Start of unmanaged code area for action  Catalog_managerYaml.voc_***REMOVED***2dcatsubtheme
            val subthemeList: Seq[VocKeyValueSubtheme] = VocServiceRegistry.vocRepository.***REMOVED***2dcatSubtheme(input._1, input._2)
            Voc_***REMOVED***2dcatsubtheme200(subthemeList)
            // ----- End of unmanaged code area for action  Catalog_managerYaml.voc_***REMOVED***2dcatsubtheme
        }
        ...
        val voc_***REMOVED***2dcattheme = voc_***REMOVED***2dcatthemeAction { (themeid: String) =>  
            // ----- Start of unmanaged code area for action  Catalog_managerYaml.voc_***REMOVED***2dcattheme
            NotImplementedYet
            // ----- End of unmanaged code area for action  Catalog_managerYaml.voc_***REMOVED***2dcattheme
        }
...
//            }
            ...
            //InputSrc(sftp: InputSrcSftp, srv_pull: InputSrcSrv_push, srv_push: InputSrcSrv_push, ***REMOVED***_dataset: InputSrcDaf_dataset)
...
//            logger.info(currentRequest.headers.get("authorization").get)
            ...
            val createDir = ws.url("***REMOVED***://security-manager.default.svc.cluster.local:9000/security-manager/v1/sftp/init/" + URLEncoder.encode(path, "UTF-8") + s"?orgName=${feed.dcatapit.owner_org.get}")
