...
import it.gov.***REMOVED***.catalogmanager.service.CkanRegistry
...
class CkanController @Inject() (wsc: WSClient, config: ConfigurationProvider, secInvokManager:SecuredInvocationManager) extends Controller {
  ...
  def createDataset = Action.async { implicit request =>
    ...
    //curl -H "Content-Type: application/json" -X POST -d @data.json ***REMOVED***://localhost:9001/ckan/createDataset
    ...
    if(ENV == "dev"){
      ...
      def callCreateDataset(cookie: String,wsClient: WSClient):Future[WSResponse] = {
       ...
       // TODO NO GOOD URL STRING PUT IN CONFIG
        wsClient.url("***REMOVED***://ckan-geo.default.svc.cluster.local:5000" + "/api/3/action/package_create").withHeaders("Cookie" -> cookie).post(jsonString)
  ...
  def updateDataset(datasetId :String)= Action.async { implicit request =>
    ...
    //curl -H "Content-Type: application/json" -X PUT -d @datavv.json ***REMOVED***://localhost:9001/ckan/updateDataset/id=81b643bd-007e-44cb-b724-0a02018db6d9
  ...
  def purgeDataset(datasetId :String) = Action.async { implicit request =>
    ...
    //curl -H "Content-Type: application/json" -X DELETE ***REMOVED***://localhost:9001/ckan/purgeDataset/mydataset
  ...
  def createOrganization = Action.async { implicit request =>
    ...
    //curl -H "Content-Type: application/json" -X POST -d @org.json ***REMOVED***://localhost:9001/ckan/createOrganization dove org.json contiene
  ...
  def createUser = Action.async { implicit request =>
    ...
    curl -H "Content-Type: application/json" -X POST -d @user.json ***REMOVED***://localhost:9001/ckan/createUser dove user.json contiene
    {
      "name": "test_user",
      "email": "test@test.org",
      "password": "password",
  ...
  def updateOrganization(orgId :String)= Action.async { implicit request =>
    ...
    // curl -H "Content-Type: application/json" -X PUT -d @org.json ***REMOVED***://localhost:9001/ckan/updateOrganization/id=232cad97-ecf2-447d-9656-63899023887t
  ...
  def deleteOrganization(orgId :String) = Action.async { implicit request =>
    ...
    //curl -H "Content-Type: application/json" -X DELETE ***REMOVED***://localhost:9001/ckan/deleteOrganization/apt-altopiano-di-pine-e-valle-di-cembra2
  ...
  def purgeOrganization(orgId :String) = Action.async { implicit request =>
    ...
    //curl -H "Content-Type: application/json" -X DELETE ***REMOVED***://localhost:9001/ckan/purgeOrganization/apt-altopiano-di-pine-e-valle-di-cembra2
  ...
  def getDatasetListWithResources(limit:Option[Int], offset:Option[Int]) = Action.async { implicit request =>
    ...
    // curl -X GET "***REMOVED***://localhost:9001/ckan/datasetsWithResources?limit=1&offset=1"
