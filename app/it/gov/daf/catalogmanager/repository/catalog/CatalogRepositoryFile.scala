  package it.gov.***REMOVED***.catalogmanager.repository.catalog
  ...
  import it.gov.***REMOVED***.catalogmanager.utilities.{CatalogManager, CoherenceChecker}
  import it.gov.***REMOVED***.catalogmanager.utilities.uri.UriDataset
  import play.Environment
  import play.api.libs.json._
  import play.api.libs.ws.WSClient
  //import it.gov.***REMOVED***.catalogmanager.utilities.datastructures._
